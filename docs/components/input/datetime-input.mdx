...
The initial value of the datetime input. Defaults to `null`. You can also update the value of the datetime input at any time using the [`page.setInputs()`](/page-actions/set-inputs) method.
