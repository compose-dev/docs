...
Paginated tables require a slightly different configuration to enable row selections. Read more in the [paginated row selection guide](#enable-row-selection).
